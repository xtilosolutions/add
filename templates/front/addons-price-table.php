	...
	<table class="<?php echo esc_attr( $total_price_box ); ?>">
		<?php if ( $blocks_product_price > 0 ) : ?>
			<tr class="wapo-product-price" style="<?php echo esc_attr( 'only_final' === $total_price_box ? 'display: none;' : '' ); ?>">
				...
				<td id="wapo-total-product-price"><?php echo wp_kses_post( wc_price( $blocks_product_price, array( 'currency' => $currency ) ) ); ?><?php echo wc_tax_enabled() ? wp_kses_post( $price_suffix ) : ''; ?></td>
			</tr>
		<?php endif; ?>
