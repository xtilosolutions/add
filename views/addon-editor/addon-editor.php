		...
		<div id="addon-editor" class="yith-wapo-addon-type-<?php echo esc_html( $addon_type ); ?>" data-addon-type="<?php echo esc_html( $addon_type ); ?>">
			...
			<?php if ( '' !== $addon_type ) :
				...
				<form action="admin.php?page=yith_wapo_panel&tab=blocks" method="post" id="addon">
					...
					<?php if ( 'new' === $addon_id ) : ?>
						<a class="back-to-type-choice" href="admin.php?page=yith_wapo_panel&tab=blocks&block_id=<?php echo esc_attr( $block_id ); ?>&addon_id=new">
                            <?php
					...
					<div id="addon-editor-type" class="addon-editor-type-<?php echo esc_html( $addon_type ); ?>">
						...
						<div id="addon-container">
							...
							<div id="tab-options-list">
                                ...
                                <?php
                                /**
                                 * @var YITH_WAPO_Addon $default_addon The default add-on.
                                 */
                                $default_addon = yith_wapo_instance_class( 'YITH_WAPO_Addon', array( 'id' => 'new' ) );
                                ?>
                                    <script type="text/html" id="tmpl-new-option">
                                        <div class="option open" data-index="<?php echo esc_attr( '{{{data.id}}}' ); ?>">
                                        <div class="actions">
                                                <?php
                                                    $actions = array(
                                                        'delete'    => $delete_action,
                                                    ...
                                                    <div class="additional-options">
                                                        <div class="selected-by-default">
                                                            <?php if ( in_array( $addon_type, array( 'checkbox', 'color', 'label', 'product', 'radio', 'select' ), true ) ) : ?>
                                                                ...
                                                                <div class="field-default">
                                                                    <?php
                                                                    $is_default = $default_addon->get_option( 'default', '{{{data.id}}}', 'no', false ) === 'yes';

                                                                    yith_plugin_fw_get_field(
                                                                        array(
                                                                            'id'    => 'option-default-' . '{{{data.id}}}',
                                                                            'name'  => 'options[default][' . '{{{data.id}}}' . ']',
                                                                            'type'  => 'checkbox',
                                                                            'class' => 'selected-by-default-chbx checkbox',
                                                                            'value' => $is_default,
                                                                        ),
                                                                ...
                                                                <label for="option-default-<?php echo esc_attr( '{{{data.id}}}' ); ?>" class="selected-by-default-chbx">
                                                                    <?php
                                                                    //translators: Add-on editor panel.
                                                        ...
                                                        <div class="enabled">
                                                            <?php
                                                            $enabled = $default_addon->get_option( 'addon_enabled', '{{{data.id}}}', 'yes', false );

                                                            yith_plugin_fw_get_field(
                                                                array(
                                                                    'id'      => 'addon-option-enabled-' . '{{{data.id}}}',
                                                                    'name'    => 'options[addon_enabled][' . '{{{data.id}}}' . ']',
                                                                    'class'   => 'enabler',
                                                                    'default' => 'yes',
                                                                    'type'    => 'onoff',
                                                                    'value'   => $enabled,
                    ...
                    <input type="hidden" name="block_name" value="<?php echo ! empty( $block->get_name() ) ? $block->get_name() : ( esc_html( stripslashes( $_REQUEST['block_name'] ) ) ?? '' ); // phpcs:ignore WordPress.Security.NonceVerification.Recommended ?>">
                    <input type="hidden" name="block_priority" value="<?php echo ! empty( $block->get_priority() ) ? $block->get_priority() : ( esc_attr( $_REQUEST['block_priority'] ) ?? '' ); // phpcs:ignore WordPress.Security.NonceVerification.Recommended ?>">
                    <input type="hidden" name="block_rule_show_in" value="<?php echo ! empty( $block->get_rule( 'show_in', '' ) ) ? $block->get_rule( 'show_in' ) : ( esc_attr( $_REQUEST['block_rule_show_in'] ) ?? '' ); // phpcs:ignore WordPress.Security.NonceVerification.Recommended ?>">
                    <input type="hidden" name="block_rule_show_in_products" value="<?php echo ! empty( $block->get_rule( 'show_in_products', '' ) ) ? esc_attr( wp_json_encode( $block->get_rule( 'show_in_products' ) ) ) : ( isset( $_REQUEST['block_rule_show_in_products'] ) ? esc_attr( wp_json_encode( $_REQUEST['block_rule_show_in_products'] ) ) : '' ); // phpcs:ignore WordPress.Security.NonceVerification.Recommended ?>">
                    <input type="hidden" name="block_rule_show_in_categories" value="<?php echo ! empty( $block->get_rule( 'show_in_categories', '' ) ) ? esc_attr( wp_json_encode( $block->get_rule( 'show_in_categories' ) ) ) : ( isset( $_REQUEST['block_rule_show_in_categories'] ) ? esc_attr( wp_json_encode( $_REQUEST['block_rule_show_in_categories'] ) ) : '' ); // phpcs:ignore WordPress.Security.NonceVerification.Recommended ?>">
                    <input type="hidden" name="block_rule_exclude_products" value="<?php echo ! empty( $block->get_rule( 'exclude_products', '' ) ) ? esc_attr( wp_json_encode( $block->get_rule( 'exclude_products' ) ) ) : ( isset( $_REQUEST['block_rule_exclude_products'] ) ? esc_attr( wp_json_encode( $_REQUEST['block_rule_exclude_products'] ) ) : '' ); // phpcs:ignore WordPress.Security.NonceVerification.Recommended ?>">
                    <input type="hidden" name="block_rule_exclude_products_products" value="<?php echo ! empty( $block->get_rule( 'exclude_products_products', '' ) ) ? esc_attr( wp_json_encode( $block->get_rule( 'exclude_products_products' ) ) ) : ( isset( $_REQUEST['block_rule_exclude_products_products'] ) ? esc_attr( wp_json_encode( $_REQUEST['block_rule_exclude_products_products'] ) ) : '' ); // phpcs:ignore WordPress.Security.NonceVerification.Recommended ?>">
                    <input type="hidden" name="block_rule_exclude_products_categories" value="<?php echo ! empty( $block->get_rule( 'exclude_products_categories', '' ) ) ? esc_attr( wp_json_encode( $block->get_rule( 'exclude_products_categories' ) ) ) : ( isset( $_REQUEST['block_rule_exclude_products_categories'] ) ? esc_attr( wp_json_encode( $_REQUEST['block_rule_exclude_products_categories'] ) ) : '' ); // phpcs:ignore WordPress.Security.NonceVerification.Recommended ?>">
                    <input type="hidden" name="block_rule_show_to" value="<?php echo ! empty( $block->get_rule( 'show_to', '' ) ) ? esc_attr( wp_json_encode( $block->get_rule( 'show_to' ) ) ) : ( isset( $_REQUEST['block_rule_show_to'] ) && ! empty( $_REQUEST['block_rule_show_to'] ) ? esc_attr( wp_json_encode( $_REQUEST['block_rule_show_to'] ) ) : 'all' ); // phpcs:ignore WordPress.Security.NonceVerification.Recommended ?>">
                    <input type="hidden" name="block_rule_show_to_user_roles" value="<?php echo ! empty( $block->get_rule( 'show_to_user_roles', '' ) ) ? esc_attr( wp_json_encode( $block->get_rule( 'show_to_user_roles' ) ) ) : ( isset( $_REQUEST['block_rule_show_to_user_roles'] ) ? esc_attr( wp_json_encode( $_REQUEST['block_rule_show_to_user_roles'] ) ) : '' ); // phpcs:ignore WordPress.Security.NonceVerification.Recommended ?>">
						...
						<?php foreach ( YITH_WAPO()->get_html_types() as $key => $html_type ) : ?>
                            ...
                            $html_url = add_query_arg(
                                array(
                                    ...
                                    'block_name'                             => isset( $_REQUEST['block_name'] ) && ! empty( $_REQUEST['block_name'] ) ? stripslashes( wc_clean( $_REQUEST['block_name'] ) ) : '', // phpcs:ignore WordPress.Security.NonceVerification.Recommended
                                    'block_priority'                         => isset( $_REQUEST['block_priority'] ) && ! empty( $_REQUEST['block_priority'] ) ? $_REQUEST['block_priority'] : '', // phpcs:ignore WordPress.Security.NonceVerification.Recommended
                                    'block_rule_show_in'                     => isset( $_REQUEST['block_rule_show_in'] ) && ! empty( $_REQUEST['block_rule_show_in'] ) ? $_REQUEST['block_rule_show_in'] : '', // phpcs:ignore WordPress.Security.NonceVerification.Recommended
                                    'block_rule_show_in_products'            => isset( $_REQUEST['block_rule_show_in_products'] ) && ! empty( $_REQUEST['block_rule_show_in_products'] ) ? $_REQUEST['block_rule_show_in_products'] : '', // phpcs:ignore WordPress.Security.NonceVerification.Recommended
                                    'block_rule_show_in_categories'          => isset( $_REQUEST['block_rule_show_in_categories'] ) && ! empty( $_REQUEST['block_rule_show_in_categories'] ) ? $_REQUEST['block_rule_show_in_categories'] : '', // phpcs:ignore WordPress.Security.NonceVerification.Recommended
                                    'block_rule_exclude_products'            => isset( $_REQUEST['block_rule_exclude_products'] ) && ! empty( $_REQUEST['block_rule_exclude_products'] ) ? $_REQUEST['block_rule_exclude_products'] : '', // phpcs:ignore WordPress.Security.NonceVerification.Recommended
                                    'block_rule_exclude_products_products'   => isset( $_REQUEST['block_rule_exclude_products_products'] ) && ! empty( $_REQUEST['block_rule_exclude_products_products'] ) ? $_REQUEST['block_rule_exclude_products_products'] : '', // phpcs:ignore WordPress.Security.NonceVerification.Recommended
                                    'block_rule_exclude_products_categories' => isset( $_REQUEST['block_rule_exclude_products_categories'] ) && ! empty( $_REQUEST['block_rule_exclude_products_categories'] ) ? $_REQUEST['block_rule_exclude_products_categories'] : '', // phpcs:ignore WordPress.Security.NonceVerification.Recommended
                                    'block_rule_show_to'                     => isset( $_REQUEST['block_rule_show_to'] ) && ! empty( $_REQUEST['block_rule_show_to'] ) ? $_REQUEST['block_rule_show_to'] : '', // phpcs:ignore WordPress.Security.NonceVerification.Recommended
                                    'block_rule_show_to_user_roles'          => isset( $_REQUEST['block_rule_show_to_user_roles'] ) && ! empty( $_REQUEST['block_rule_show_to_user_roles'] ) ? $_REQUEST['block_rule_show_to_user_roles'] : '', // phpcs:ignore WordPress.Security.NonceVerification.Recommended
                                ),
                                admin_url( '/admin.php' )
                            );
                            ?>
